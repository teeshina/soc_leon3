...
#define CFG_APBUART_FIFOSZ  16 // 1 to 32
#define CFG_APBUART_ABITS   8
#define CFG_APBUART_SBITS   12//: integer range 12 to 32 := 12);
#define CFG_APBUART_FLOW    1

#define CFG_GNSS_GPS_L1CA_NUM     12
#define CFG_GNSS_SBAS_L1_NUM      2
#define CFG_GNSS_GALILEO_E1_NUM   6
#define CFG_GNSS_GLONASS_L1_NUM   12
#define CFG_GNSS_CHANNELS_TOTAL   (CFG_GNSS_GPS_L1CA_NUM+CFG_GNSS_SBAS_L1_NUM+CFG_GNSS_GALILEO_E1_NUM+CFG_GNSS_GLONASS_L1_NUM)
#define CFG_GNSS_TIMERS_TOTAL     1
#define CFG_GNSS_NOISE            1
#define CFG_GNSS_MISC             1
#define CFG_GNSS_MODULES_TOTAL    (CFG_GNSS_CHANNELS_TOTAL+CFG_GNSS_TIMERS_TOTAL+CFG_GNSS_NOISE+CFG_GNSS_MISC)
#define CFG_GNSS_DWORD_PER_MODULE 8
#define CFG_GNSS_MEMORY_SIZE64    (CFG_GNSS_DWORD_PER_MODULE*CFG_GNSS_MODULES_TOTAL)
#define CFG_GNSS_ADDR_WIDTH       (log2x[CFG_GNSS_MEMORY_SIZE64/8]+6)

static const uint32 MODULE_ID_GLB_TIMER = 0+CFG_GNSS_CHANNELS_TOTAL;
static const uint32 MODULE_ID_NOISE     = MODULE_ID_GLB_TIMER+1;
static const uint32 MODULE_ID_MISC      = MODULE_ID_NOISE+1;
static const uint32 MODULE_ID_TOTAL     = MODULE_ID_MISC+1;
