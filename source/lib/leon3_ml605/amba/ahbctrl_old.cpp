...
//****************************************************************************
uint32 ahbctrl::tz( uint32 inVect[2*AHB_MASTERS_TOTAL_2n],
                    uint32 inVectLength)
{
...
void ahbctrl::selmast( uint32  inAhbMaster,
                       uint32  inAhbBusRequest[AHB_MASTERS_TOTAL_2n],
                       uint32  inAhbSplit[AHB_MASTERS_TOTAL_2n],// : in std_logic_vector(0 to nahbmx-1);
                       ...
                       uint32& outDefmstEna)// : out std_ulogic)
{
  ...
  uint32 rrvec[2*AHB_MASTERS_TOTAL_2n];
...
// error response on undecoded area
  ...
  // split support
#ifdef CONFIG_AHB_SPLIT
  uint32 wbMstSplit[AHB_MASTERS_TOTAL_2n];
